    ...
    public static async Task SeedAsync(UtilityMapDbContext context)
    {
        ...
        var floors = new List<FloorPlan>
        {
            new FloorPlan
            {
                ...
                {
                    new() { ShopName = "Event Hall - Floor 1", LocationSlot = "EH-01", X = 44.00, Y = 38.00, ShopUrl = "/events", StorefrontImageUrl = "/images/maps/event-hall.png" },
            ...
            new FloorPlan
            {
                ...
                Locations = new List<MapLocation>
                {
                    new() { ShopName = "Event Hall - Floor 3", LocationSlot = "EH-03", X = 49.00, Y = 45.00, ShopUrl = "/events", StorefrontImageUrl = "/images/maps/event-hall.png" },
            ...
            new FloorPlan
            {
                ...
                Locations = new List<MapLocation>
                {
                    new() { ShopName = "Event Hall - Floor 4", LocationSlot = "EH-04", X = 49.00, Y = 45.00, ShopUrl = "/events", StorefrontImageUrl = "/images/maps/event-hall.png" },
