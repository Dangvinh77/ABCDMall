        ...
        var floors = new List<FloorPlan>
        {
            ...
            new FloorPlan
            {
                ...
                Locations = new List<MapLocation>
                {
                    ...
                    new() { ShopName = "Starbucks Coffee",  LocationSlot = "1-09A", X= 21.48, Y= 38.11, ShopUrl = "/shops/starbucks",           StorefrontImageUrl = "/img/2lands/logo.png" },
            ...
            new FloorPlan
            {
                ...
                Locations = new List<MapLocation>
                {
                    ...
                    new() { ShopName = "Kichi Kichi",         LocationSlot = "5-02",  X = 79.00, Y = 28.50, ShopUrl = "/food/kichi-kichi",         StorefrontImageUrl = "/img/kichi/logo.png" },
            ...
            new FloorPlan
            {
                ...
                Locations = new List<MapLocation>
                {
                    ...
                    new() { ShopName = "Dookki",              LocationSlot = "6-03A", X= 47.66, Y= 36.69, ShopUrl = "/food/dookki-vietnam",               StorefrontImageUrl = "" },
                    ...
                    new() { ShopName = "Hot Pot Story",       LocationSlot = "6-13",  X= 40.03, Y= 48.91, ShopUrl = "/food/hot-pot-story",         StorefrontImageUrl = "" },
                    ...
                    new() { ShopName = "Lẩu Nướng 88",       LocationSlot = "6-10",  X= 57.28, Y= 54.51, ShopUrl = "/food/lu-nuong-88",         StorefrontImageUrl = "" },
